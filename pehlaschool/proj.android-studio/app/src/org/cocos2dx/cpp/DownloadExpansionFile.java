...
public class DownloadExpansionFile extends Activity implements IDownloaderClient {
    ...
    public static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    4, // version of the APK that the file was uploaded
                    1276290711L // length of the file in bytes
            ),
            new XAPKFile(
                    false, // false signifies a patch file
                    0, // version of the APK that the file was uploaded
                    0 // length of the file in bytes
            )
    };
