...
void DailyScene2::showFreechoicePopup(std::string gameName, int maxPlayable, int maxAvailable)
{
    ...
    gquiz1.insert(pair<string, vector<string>>("ReadingBird", {"पढ़ने वाला पक्षी", "ReadingBird", "পাখি পড়া"}));
    ...
    gquiz1.insert(pair<string, vector<string>>("Tapping", {"बबल पॉप", "Tapping", "বাবল পপ"}));
    gquiz1.insert(pair<string, vector<string>>("StarFall", {"टाइपिंग", "Star Fall", "টাইপিং"}));
    ...
    gquiz1.insert(pair<string, vector<string>>("WordTracing", {"शब्द अनुरेखण", "WordTracing", "শব্দ ট্রেসিং"}));
