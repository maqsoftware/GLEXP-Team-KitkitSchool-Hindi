...
string getDocumentsPath()
{
    ...
    string dir("");
    string tmp = JniHelper::callStaticStringMethod("org/cocos2dx/cpp/library/activity/AppActivity", "getDocumentsPath");
...
#if CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID
    string dir("");
    string tmp = JniHelper::callStaticStringMethod("org/cocos2dx/cpp/library/activity/AppActivity", "getLaunchString");
...
#if CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID
    JniHelper::callStaticVoidMethod("org/cocos2dx/cpp/library/activity/AppActivity", "clearLaunchString");
#elif CC_TARGET_PLATFORM == CC_PLATFORM_WINRT
	__launchString = "";
#endif
...
void MainScene::menuCloseCallback(Ref* pSender)
{
    ...
    bool result = JniHelper::getStaticMethodInfo(t, "org/cocos2dx/cpp/library/activity/AppActivity", "sendToBack", "()V");
    if (result)
    {
