...
void BookPage::setTitle(string title, string titleImagePath, string audioPath, TDBookLayout layout, float delay)
{
    ...
    if (layout==TDBookLayout::Portrait || layout==TDBookLayout::Portrait_Traditional) {
        ...
        if (layout==TDBookLayout::Portrait_Traditional) {
            _textView->addChild(labelFunc(Color4B(77, 35, 20, 255), fontArial, Size(0, 0)));
        } else {
            _textView->addChild(labelFunc(Color4B(148, 94, 48, 255), fontArial, Size(5, -5)));
            _textView->addChild(labelFunc(Color4B(255, 250, 227, 255), fontArial, Size(0, 0)));
        }
        ...
        auto labelFunc = [&](Color4B color, Size offset){
            ...
            auto l = Label::createWithSystemFont(title, fontArial, fontSize, Size(textViewSize.width, 0), TextHAlignment::CENTER, TextVAlignment::CENTER);
            auto lSize = l->getContentSize();
            if (lSize.height > textViewSize.height) {
                l->setScale(textViewSize.height / lSize.height);
            }
...
void BookPage::setCreditPage()
{
    ...
    if (_bookLayout==TDBookLayout::Portrait || _bookLayout==TDBookLayout::Portrait_Traditional) {
        ...
        
        {
            ...
            Label* label = Label::createWithSystemFont(titleTxt, fontArial, 50, Size::ZERO, TextHAlignment::CENTER, TextVAlignment::CENTER);
            if (_bookLayout==TDBookLayout::Portrait_Traditional) {
        ...
        
        {
            ...
            Label* label = Label::createWithSystemFont(creditTxt, fontArial, 30, textViewSize, TextHAlignment::CENTER, TextVAlignment::TOP);
        ...
        
        {
            ...
            auto bottom = Label::createWithSystemFont(licenseTxt, fontArial, 15, Size(0, 0), TextHAlignment::CENTER, TextVAlignment::CENTER);
            ...
            auto enuma = Label::createWithSystemFont("(c) 2015 Enuma, Inc.", fontArial, 20);
        ...
        
        {
            ...
            auto enuma = Label::createWithSystemFont("(c) 2015 Enuma, Inc.", fontArial, 15);
...
Node* BookPage::createTextViewOneLine(Size size, float fontSize)
{
    ...
    for (int i=0; i<_words.size(); i++) {
        ...
        wordButton->setTitleFontName(fontArial);
