...
void PlaceValueScene::createBoard(int index)
{
    ...
    auto tank100_title = Label::createWithSystemFont(tank100_title_text, fontArial, 30);
    ...
    auto tank10_title = Label::createWithSystemFont(tank10_title_text, fontArial, 30);
    ...
    auto tank1_title = Label::createWithSystemFont(tank1_title_text, fontArial, 30);
    ...
    auto nextTank100_title = Label::createWithSystemFont(tank100_title_text, fontArial, 30);
    ...
    auto nextTank10_title = Label::createWithSystemFont(tank10_title_text, fontArial, 30);
    ...
    auto nextTank1_title = Label::createWithSystemFont(tank1_title_text, fontArial, 30);
...
WaterDropLandPiece *PlaceValueScene::createWaterDropLandPiece(int count)
{
    ...
    if (count == 100)
    {
        ...
        auto indicationText = Label::createWithSystemFont("+100", fontArial, 50);
    ...
    else if (count == 10)
    {
        ...
        auto indicationText = Label::createWithSystemFont("+10", fontArial, 50);
    ...
    else if (count == 1)
    {
        ...
        auto indicationText = Label::createWithSystemFont("+1", fontArial, 50);
