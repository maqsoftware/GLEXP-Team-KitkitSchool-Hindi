...
void WordWindowScene::createQuestion()
{
	...
	m_pLabelQuestion = TodoUtil::createLabelMultilineToFit(newText, 60.f, Size(1424.f, 800.f), defaultFont, Color4B::WHITE, TextHAlignment::LEFT, TextVAlignment::CENTER);
