...
import com.maq.xprize.kitkitlibrary.english.R;
import com.maq.xprize.kitkitlibrary.english.SelectActivity;
...
public class DownloadExpansionFile extends Activity implements IDownloaderClient {
    ...
    public static final XAPKFile xAPK = new
            ...
            11,// the version of the APK that the file was uploaded
            // against
            1569810587// the length of the file in bytes
            )
            ;
    /* expansion services*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!expansionFilesDelivered()) {
            ...
            Intent intent = new Intent(vContext, SelectActivity.class);
    ...
    public void onDownloadStateChanged(int newState) {
        ...
        switch (newState) {
            case IDownloaderClient.STATE_IDLE:
                // STATE_IDLE means the services is listening, so it's
