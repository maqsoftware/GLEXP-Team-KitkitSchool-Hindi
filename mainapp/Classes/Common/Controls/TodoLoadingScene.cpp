...
//    auto cur = CurriculumManager::getInstance()->findCurriculum(levelID);
    ...
    std::string loadingText = LanguageManager::getInstance()->isEnglish() ? "براۓ مہربانی انتظار کريں..." : "Tafadhali subiri...";
    
    Label *loadingLabel = Label::createWithSystemFont(loadingText, "arial", 150);
