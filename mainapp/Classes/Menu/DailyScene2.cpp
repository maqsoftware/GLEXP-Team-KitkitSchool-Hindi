...
void DailyScene2::showFreechoicePopup(std::string gameName, int maxPlayable, int maxAvailable)
{
    ...
    gquiz1.insert(pair<string, string>(3, "BirdPhonics"));
    gquiz1.insert(pair<string, string>(4, "BookWithQuiz"));
    gquiz1.insert(pair<string, string>(5, "Counting"));
    gquiz1.insert(pair<string, string>(6, "DoubleDigit"));
    gquiz1.insert(pair<string, string>(7, "EquationMaker"));
    gquiz1.insert(pair<string, string>(8, "FeedingTime"));
    gquiz1.insert(pair<string, string>(9, "FindTheMatch"));
    gquiz1.insert(pair<string, string>(10,"FishTank"));
    gquiz1.insert(pair<string, string>(11,"HundredPuzzle"));
    gquiz1.insert(pair<string, string>(12, "Labeling"));
    gquiz1.insert(pair<string, string>(13, "LetterMatching"));
    gquiz1.insert(pair<string, string>(14, "TutorialTrace"));
    gquiz1.insert(pair<string, string>(15, "LetterTrace"));
    gquiz1.insert(pair<string, string>(16, "LetterTracingCard"));
    gquiz1.insert(pair<string, string>(17, "LineMatching"));
    gquiz1.insert(pair<string, string>(18, "LRComprehension"));
    gquiz1.insert(pair<string, string>(19, "MangoShop"));
    gquiz1.insert(pair<string, string>(20, "MathKicker"));
    gquiz1.insert(pair<string, string>(21, "MisingNumber"));
    gquiz1.insert(pair<string, string>(22,"MovingInsects"));
    gquiz1.insert(pair<string, string>(23, "MultiplicationBoard"));
    gquiz1.insert(pair<string, string>(24,"NumberMatching"));
    gquiz1.insert(pair<string, string>(26, "NumberTracing"));
    gquiz1.insert(pair<string, string>(25,"NumberPuzzle"));
    gquiz1.insert(pair<string, string>(27,"NumberTracingExt"));
    gquiz1.insert(pair<string, string>(28, "NumberTrain"));
    gquiz1.insert(pair<string, string>(29, "PatternTrain"));
    gquiz1.insert(pair<string, string>(30, "PlaceValue"));
    gquiz1.insert(pair<string, string>(31, "QuickFacts"));
    gquiz1.insert(pair<string, string>(32, "ReadingBird"));
    gquiz1.insert(pair<string, string>(33, "SentenceBridge"));
    gquiz1.insert(pair<string, string>(34, "SentenceMaker"));
    gquiz1.insert(pair<string, string>(35, "ShapeMatching"));
    gquiz1.insert(pair<string, string>(36, "SoundTrain"));
    gquiz1.insert(pair<string, string>(37, "Spelling"));
    gquiz1.insert(pair<string, string>(38,"BubblePop"));
    gquiz1.insert(pair<string, string>(39,"Bubble"));
    gquiz1.insert(pair<string, string>(40,"StarFall"));
    gquiz1.insert(pair<string, string>(41, "ThirtyPuzzle"));
    gquiz1.insert(pair<string, string>(42, "WhatIsThis"));
    gquiz1.insert(pair<string, string>(43, "WordWindow"));
    gquiz1.insert(pair<string, string>(44, "WordTracing"));
    gquiz1.insert(pair<string, string>(45, "WordKicker"));
    gquiz1.insert(pair<string, string>(46, "WordNote"));
    gquiz1.insert(pair<string, string>(47, "WordMatrix"));
    gquiz1.insert(pair<string, string>(48,"WordMachine"));
    gquiz1.insert(pair<string, string>(49, "WordWindow"));

    switch(index)
    {
        case 1:
            VoiceMoldManager::shared()->speak("","hi-IN");
        case 2:
            VoiceMoldManager::shared()->speak("","hi-IN");
        case 3:
